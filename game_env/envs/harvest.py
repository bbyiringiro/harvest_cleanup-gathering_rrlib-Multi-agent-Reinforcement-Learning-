...
from game_env.envs.agent import HarvestAgent  # HARVEST_VIEW_SIZE
from game_env.constants import HARVEST_MAP
from game_env.envs.map_env import MapEnv, ACTIONS
...
class HarvestEnv(MapEnv):
    ...
    def __init__(self, ascii_map=HARVEST_MAP, num_agents=1, config=None, render=False):
        super().__init__(ascii_map, num_agents, config=config, render=render)
        self.apple_points = []
        self.num_waster_clean =-1
